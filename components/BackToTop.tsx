  ...
  return (
    <>
      {isVisible && (
        ...
        >
          <div className="absolute transition-all duration-1000 opacity-70 -inset-px bg-gradient rounded-full blur-md group-hover:opacity-100 group-hover:-inset-1 group-hover:duration-200 animate-tilt"></div>
