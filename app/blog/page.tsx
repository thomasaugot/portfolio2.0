...
const Blog: React.FC = () => {
  ...
  const blogs = [
    {
      title: t("How to Start Scroll at Bottom in React"),
      content: t(
    ...
    {
      title: t(
        ".dotenv Environment Variables in Next.JS Not Found: The Solution"
      ),
      content: t(
    ...
    {
      title: t("Adding Zoom Functionality to an Image Viewer in React/Next.JS"),
      content: t(
    ...
    {
      title: t("Make your website Multilingual with react-i18next"),
      content: t(
    ...
    },
    {
      ...
      content: t("A Time-Saving Blueprint for Faster Website Development..."),
      image: article6,
      mediumLink:
    ...
    {
      title: t("Implement a Dark Mode in React & SCSS using Context API"),
      content: t(
    ...
    {
      title: t("Offline Mode in React Native with AsyncStorage"),
      content: t(
    ...
    {
      title: t("Making My React Native App More Secure in 2023"),
      content: t(
    ...
    {
      title: t("Supabase in React/React-Native for Beginners: The Basics"),
      content: t(
    ...
    {
      title: t("Optimizing Performance in React Native"),
      content: t(
    ...
    {
      title: t("Create a React Contact Form with Email.js"),
      content: t(
    ...
    {
      title: t("Build A Responsive React Navbar Component with SCSS"),
      content: t(
    ...
    {
      title: t("Save yourself hours of coding with these CSS generators"),
      content: t(
    ...
    {
      title: t("Which BaaS (Backend as a Service) to choose in 2023?"),
      content: t(
